...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		'id' => 'acf_universal-top-bar',
		'title' => 'Universal Top Bar',
		'fields' => array (
			array (
				'key' => 'field_593ea4a5c5229',
				'label' => 'Phone section',
				'name' => '',
				'type' => 'tab',
			),
			array (
				'key' => 'field_593ea58fc522a',
				'label' => 'Phone blurb',
				'name' => 'phone_blurb',
				'type' => 'text',
				'instructions' => 'Add message to the phone section.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_593ea5e0c522b',
				'label' => 'Phone number',
				'name' => 'phone_number',
				'type' => 'text',
				'instructions' => 'Add phone number how you\'d like to be displayed, ie with some space between the numbers.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_593ea667c522c',
				'label' => 'Phone number - with no spaces',
				'name' => 'phone_number_wns',
				'type' => 'text',
				'instructions' => 'Add phone number without any space in between the numbers.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_593ea6acc522d',
				'label' => 'Email section',
				'name' => '',
				'type' => 'tab',
			),
			array (
				'key' => 'field_593ea6cec522e',
				'label' => 'Email blurb',
				'name' => 'email_blurb',
				'type' => 'text',
				'instructions' => 'Add message to the email section.',
				'required' => 1,
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
